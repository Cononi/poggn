...
async function run() {
    ...
    if (command === "init") {
        ...
        const language = (typeof options.lang === "string" ? options.lang : "ko");
        const autoMode = (typeof options.auto === "string" ? options.auto : "on");
        const teamsMode = (typeof options.teams === "string" ? options.teams : "off");
        const gitMode = (typeof options.git === "string" ? options.git : "off");
