...
- 각 timestamp에는 source 또는 confidence를 연결한다.
  - high: `state/history.ndjson`의 `stage-started`, `stage-progress`, `stage-completed`, `stage-revised`
...
- completed flow는 trusted `completedAt` 또는 명확한 stage completion evidence가 있어야 한다.
