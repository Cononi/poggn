...
| 003 | UPDATE | `apps/dashboard/src/features/history/HistoryWorkspace.tsx` | `implementation/diffs/003_UPDATE_apps_dashboard_src_features_history_HistoryWorkspace_tsx_refactor.diff` | `T4` | Extracts Progress track connector/grid style calculation into a helper to remove repeated step-count math from JSX. |
